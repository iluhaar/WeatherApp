...
class WeatherArrayAdapter extends ArrayAdapter<Weather> {
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
      ...
      viewHolder.humidityTextView.setText(
       ...
       Log.d("WeatherArrayAdapter.day", viewHolder.dayTextView.getText().toString());
       Log.d("WeatherArrayAdapter.low", viewHolder.lowTextView.getText().toString());
       Log.d("WeatherArrayAdapter.hi", viewHolder.hiTextView.getText().toString());
       Log.d("WeatherArrayAdapter.hum", viewHolder.humidityTextView.getText().toString());
